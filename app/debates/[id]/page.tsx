  ...
  return (
    <div className="min-h-screen bg-dr-base">
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        {/* Placeholder for chamber / arguments */}
        <div className="card-dr p-8 text-center">
          ...
          <p className="text-slate-400 text-sm font-medium">The debate chamber is coming soon</p>
          <p className="text-slate-600 text-xs mt-1">Arguments, evidence and the structured debate graph will appear here.</p>
        </div>
